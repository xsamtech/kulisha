...
return [
    ...
    */
    ...
    // Posts & Comments
    'post_published' => 'You have published :a_new :post_type.',
    'post_published_one_mention' => 'You have mentioned <strong><a href="/users/:to_user_id">:to_user_names</a></strong> in :a_new :post_type.',
    'post_published_two_mentions' => 'You have mentioned <strong><a href="/users/:to_user_id">:to_user_names</a></strong> and another person in :a_new :post_type.',
    'post_published_many_mentions' => 'You have mentioned <strong><a href="/users/:to_user_id">:to_user_names</a></strong> and :mentions_count others in :a_new :post_type.',
    'post_published_followers_mention' => 'You have mentioned all your connections in :a_new :post_type.',
    ...
    'one_person_post_instructive' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> considers your :post_type :instructive.',
    'two_persons_post_instructive' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> and another person consider your :post_type :instructive.',
    'many_persons_post_instructive' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> and :reactions_count others consider your :post_type :instructive.',
    ...
    // Posts & Comments
    'one_post_published' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> has published :a_new :post_type.',
    'two_posts_published' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> and another person have published :new_posts_type.',
    'many_posts_published' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> and :posts_count others have published :new_posts_type.',
    'one_mention_post' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> :mentioned you in :a_new :post_type.',
    'two_mentions_post' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> :mentioned you and another person in :a_new :post_type.',
    'many_mentions_post' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> :mentioned you and :mentions_count others in :a_new :post_type.',
    'followers_mention_post' => '<strong><a href="/users/:from_user_id">:from_user_names</a></strong> :mentioned you and all his connections in :a_new :post_type.',
