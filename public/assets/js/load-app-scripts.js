...
function loadJS() {
    $(function () {
        ...
        $.getScript(currentHost + '/assets/addons/mazer/summernote/summernote-lite.min.js');
        $.getScript(currentHost + '/assets/js/mazer/pages/dashboard.js');
        $.getScript(currentHost + '/assets/js/mazer/main.js');
